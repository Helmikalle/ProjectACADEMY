...
INSERT INTO `henkilo` VALUES(1, 'root', 'Mestari', 'P‰‰yll‰pit‰j‰',
'admin');
INSERT INTO `henkilo` VALUES(2, 'anonymous', 'Anonyymi', 'Anonyymi
k‰ytt‰j‰, ei kirjautunut', NULL);
...
INSERT INTO `viesti` VALUES(1, 1, 1, 'Sarjavinkkej‰', 'Alle vinkkej‰ lempparisarjoistanne, kiitos!', NULL, NULL, NULL);
COMMIT;
SET AUTOCOMMIT=1;